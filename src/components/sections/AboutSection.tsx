    ...
    <section id="about" className="relative bg-background py-20 md:py-32 overflow-hidden">
      ...
      <div className="container-max relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-lg text-base md:text-lg leading-relaxed mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-20 md:mb-32">
          {values.map((value, index) => (
            ...
            >
              <div className="relative h-full bg-card/50 backdrop-blur-xl border border-white/5 rounded-xl p-6 md:p-8 hover:bg-card/80 transition-all duration-300 overflow-hidden group">
                {/* Hover Gradient Blur */}
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-sm bg-white/[0.03] border border-white/5 flex items-center justify-center mb-6 text-white group-hover:bg-nzila-gold group-hover:text-black group-hover:border-nzila-gold transition-all duration-500 shadow-xl">
        ...
        <div className="relative rounded-2xl md:rounded-3xl overflow-hidden border border-white/10 bg-white/5 backdrop-blur-sm">
          <div className="grid lg:grid-cols-2">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <motion.li
                    ...
                    className="flex items-center gap-4 text-white font-medium text-sm md:text-base"
                  >
                    <CheckCircle2 className="text-nzila-gold shrink-0" size={18} />
                    {item}
                  </motion.li>
                ))}
              </ul>
            ...
            {/* Stats / Visual Side */}
            <div className="relative bg-black/40 p-10 md:p-16 flex items-center justify-center min-h-[300px] md:min-h-[400px]">
              ...
              <div className="relative z-10 text-center">
                ...
                >
                  <span className="block text-6xl md:text-8xl font-bold text-white mb-2 tracking-tighter">
                    5<span className="text-nzila-gold">+</span>
                  </span>
                  <span className="text-xs md:text-base text-muted-foreground uppercase tracking-widest font-semibold border-t border-white/10 pt-4 inline-block">
