...
export function EducationSection() {
  return (
    <section id="education" className="relative bg-background py-32 overflow-hidden">
      {/* Background Glows */}
      <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-nzila-gold/5 blur-[120px] rounded-full pointer-events-none -translate-y-1/2" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 rounded-sm bg-nzila-gold/10 border border-nzila-gold/20">
                <GraduationCap className="text-nzila-gold" size={20} />
              </div>
          ...
          >
            ...
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden border border-white/10 bg-white/5 backdrop-blur-sm p-8 flex flex-col justify-between group">
              ...
              <div className="absolute top-10 right-10 w-32 h-32 bg-nzila-gold/5 blur-3xl rounded-full" />
              <div className="absolute bottom-10 left-10 w-40 h-40 bg-white/5 blur-3xl rounded-full" />
            </div>

            {/* Decoration Card Behind */}
            <div className="absolute -z-10 top-8 -right-8 w-full h-full rounded-sm border border-white/[0.03] bg-black/40 backdrop-blur-sm" />
          </motion.div>
